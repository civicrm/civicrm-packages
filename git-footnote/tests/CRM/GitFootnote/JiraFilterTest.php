...
class JiraFilterTest extends \PHPUnit_Framework_TestCase {
   ...
   */
  public function createJiraFilter($jiraApi = NULL) {
  ...
  public function testOfflineCases($messageBody, $expectedBody, $expectedNotes) {
     ...
     * @throws \Exception
     */
  public function testReprocessOfflineCases($messageBody, $expectedBody, $expectedNotes) {
